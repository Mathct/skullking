...
define(["dojo", "dojo/_base/declare", "ebg/core/gamegui", "ebg/counter", "ebg/stock", g_gamethemeurl + "modules/js/game.js"], function (dojo, declare) {
  /* CONSTANTS HERE */
  ...
  return declare("bgagame.skullking", [customgame.game], {
    ...
    onEnteringState: function (stateName, args) {
      ...
      switch (stateName) {
        ...
        case "playerTurnMultiBid": // waiting for bid
          ...
          if (this.isCurrentPlayerActive()) {
            if (!document.getElementById("bid_0")) {
              // on le remplit s'il est vide
              this.setupBids();
            }
    ...
    divYou: function () {
      ...
      const you = `<span class="player_name_style" style="color:#${color};">${_("You")}</span>`;
      return you;*/

      return this.bga.players.getFormattedPlayerName(this.bga.players.getCurrentPlayerId(), { replaceByYou: true });
    },
    ...
    divActPlayer: function () {
      ...
      const you = `<span class="player_name_style" style="color:#${color};">${name}</span>`;
      return you;*/

      return this.bga.players.getFormattedPlayerName(this.bga.players.getActivePlayerId(), { replaceByYou: false });
    },
    ...
    `;
      ...
      if (!this.isSpectator && this.gamedatas.end_of_game == 0) {
        ...
        html = "<div class='tooltip_content'><span class='tooltip_info'>" + _("Scorepad") + "</span></div>";
    ...
    setupPanelBid: function (player) {
      ...
      html = "<div class='tooltip_content'><span class='tooltip_info'>" + _("Bid") + "</span></div>";
      ...
      html = "<div class='tooltip_content'><span class='tooltip_info'>" + _("Tricks") + "</span></div>";
    ...
    setupNewCard: function (card_div, card_type_id, card_id) {
      ...
      let html = '<div class="tooltip_bigcontent" style="background: #ebe7d8;">';
      ...
      if (card_type_id > 56 && card_type_id < 66) {
        ...
        html += `<br><span class='tooltip_desc'>${_(card_desc_2)}</span>`;
    ...
    setupTooltips: function () {
      html = "<div class='tooltip_content'><span class='tooltip_info'>" + _("Round first player") + "</span></div>";
    ...
    showHelpModal: function () {
      ...
      html +=
        ...
        _("<i>When the Kraken and White Whale are played in the same trick, only the second beast's effect applies. The first is defeated and becomes an escape card.</i>") +
        "</div>";
      ...
      html +=
        "<div class='tooltip_desc'>" +
        _("<i>Playing a loot card enters you into an alliance with the player who captures it. If both of you bid correctly, you are each awarded 20 bonus points.</i>") +
        "</div>";
...
*/
    ...
    notif_krakenEffect: async function (args) {
      for (const card of Object.values(args.cards)) {
        // pas de forEach quand il y a des await
