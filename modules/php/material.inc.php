...
$this->_SPECIAL_CARDS = [
    ...
    "pirate" => [
        ...
        "desc_1" => clienttranslate('Pirate cards beat all numbered cards and Mermaids. They are of equal rank with each other, so if more than one Pirate card is played in a trick, the person who played the first pirate wins the trick.'),
        "desc_2" => clienttranslate('If a Pirate, the Skull King and a Mermaid are all played in the same trick, the Mermaid always wins the trick, regardless of order of play. Only the Mermaid capturing the Skull King bonus is earned. ')
    ],
    "loot" => [
        ...
        "desc_2" => clienttranslate('If you lead a trick with a loot card and the cards that follow are all escapes then you would win the trick. No alliance was formed, so no bonus is awarded.')
    ],
    "kraken" => [
        "name" => clienttranslate('Kraken (x1)'),
        "desc_1" => clienttranslate('When played, the trick is destroyed entirely as the Kraken consumes all. No one wins the trick and the cards are set aside. The next trick is led by the player who would have won the trick. The Kraken and the White Whale are ancient rivals. When played in the same trick, the second one played wins the battle. That card then sets the action to be applied.'),
    ...
    "white_whale" => [
        ...
        "desc_1" => clienttranslate('When played, special cards are destroyed and can’t win! Highest numbered card wins the trick, regardless of the suit. If there is a tie, the first one played is the winner. If only special cards are played, the trick is discarded, and the whale leads the next trick. The Kraken and the White Whale are ancient rivals. When played in the same trick, the second one played wins the battle. That card then sets the action to be applied.'),
...
$this->_PIRATE_CARDS = [
    ...
    3 => [
        ...
        "ability" => clienttranslate('Bet 0, 10 or 20 points. Earn the points if you bid correctly, lose them if you fail!')
    ],
    4 => [
